...
extern BOOL kIOS6Above;
extern BOOL kIOS5Above;
...
// 如果设置为 secureText，则只安全标记匹配的规则
//@property (nonatomic, retain) NSRegularExpression *patternSecure;
...
static BOOL UIPanelPatternTypeHasBottomEdge(UIPanelPatternType ty) {
