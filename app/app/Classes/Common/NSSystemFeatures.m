           ...
           fromLocation:(CLLocation *)oldLocation
{
    ...
    li.fromLocation = oldLocation;
    li.locationValue = newLocation;
                                                    ...
                                                    suc:^(CLLocationCoordinate2D result) {
                                                        [ChinaLocationExtension asyncQueryLocation:result
                                                                                               ...
                                                                                               suc:^(NSDictionary *result) {
                                                                                                   ...
                                                                                                   [self.signals emit:kSignalLocationChanged withResult:li];
...
{
    BOOL _isacceling, _isgyroing, _ismagnetoing;
}
...
- (void)setDurationAccelerometer:(NSTimeInterval)durationAccelerometer {
    ...
    [_mtmgr setAccelerometerUpdateInterval:_durationAccelerometer];
}

- (void)setDurationGyro:(NSTimeInterval)durationGyro {
    _durationGyro = durationGyro;
    [_mtmgr setGyroUpdateInterval:durationGyro];
}
