...
/** 单次的动作 */
@interface QCTestingAction : NSObjectExt
...
/** 录制的单次测试脚本 */
@interface QCTestingProfile : NSObjectExt
...
@interface QCTestingSuite : NSObjectExt
...
/** 正在录制的脚本 */
@property (nonatomic, readonly, retain) QCTestingProfile *recordingProfile;
