...
/** 朝向 */
@property (nonatomic, readonly) CGAngle *orientation;
...
@property (nonatomic, readonly) NSLocationInfo *info;

@end

SIGNAL_DECL(kSignalLocationChanged) @"::device::location::changed";
SIGNAL_DECL(kSignalHeadingChanged) @"::device::heading::changed";
...
/** 姿态数据 */
@interface NSPostureInfo : NSObject

@property (nonatomic, readonly, retain) CMDeviceMotion *motion;

/** 水平面夹角 */
@property (nonatomic, readonly) CGAngle *angle;

/** 自身旋转 */
@property (nonatomic, readonly) CGAngle *angleRotation;
...
/** 刷新的间隔 */
@property (nonatomic, assign) NSTimeInterval durationPosture, durationAccelerometer, durationGyro;

/** 数据 */
@property (nonatomic, readonly, retain) NSPostureInfo *posture;
...
SIGNAL_DECL(kSignalPostureStarted) @"::ns::posture::started";
SIGNAL_DECL(kSignalPostureStopped) @"::ns::posture::stopped";
SIGNAL_DECL(kSignalPostureChanged) @"::ns::posture::changed";
